            ...
            <div className='container'>
                <div className='testimonials-content'>
                    <div className='section-t text-center'>
                        ...
                        <p className='text'>Descubra o que nossos clientes têm a dizer sobre a experiência excepcional que proporcionamos. Sucesso comprovado, um cliente de cada vez!
                        </p>
                    </div>
